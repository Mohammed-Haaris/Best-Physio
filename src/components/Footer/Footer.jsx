        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="text-gray-400">Sports Rehabilitation</li>
              <li className="text-gray-400">Post-Surgery Care</li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-gray-400">
                ...
                <span>47, Bashyam St, near pillaiyar koil,<br/>North Venugopalapuram, Allpettai,<br/>Cuddalore, Tamil Nadu 607001</span>
              </li>
